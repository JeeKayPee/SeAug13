...
class Ex05_UploadFile extends BaseTest2 {
	...
	@Test
	void test() {
		//ensure the app is at the state of single file uploaded, before we execute this code
		
		this.getDriver().findElement(By.linkText("Media")).click();
		this.getDriver().findElement(By.linkText("Add New")).click();

		WebElement browseButton = getDriver().findElement(By.name("async-upload"));
		...
		// you can further take actions to verify correct file upload. Skipping for this
		// exercise.
